...
def project_influence_level_calculation(user):
    influence_level = project_closeness_to_github_project_owner(user.user_cl_influence_metric) + \
                      ...
                      project_status_github(user.user_st_influence_metric) + project_status_in_the_project(user.user_stp_influence_metric) + \
